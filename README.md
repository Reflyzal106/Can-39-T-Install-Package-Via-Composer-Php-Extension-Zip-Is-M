# [SOLVED] Can-39-T-Install-Package-Via-Composer-Php-Extension-Zip-Is-M
...
>
> ### ➡️ [CLICK HERE TO VIEW THE FULL FIX GUIDE](https://techfixdocs.my.id/can-39-t-install-package-via-composer-php-extension-zip-is-m)
>
...
Enable the zip PHP extension by running `sudo apt-get install php-zip` on your Ubuntu system.
...
👉 **[Go to ErrorFix Hub Full Article](https://techfixdocs.my.id/can-39-t-install-package-via-composer-php-extension-zip-is-m)**
